...
O vault está organizado por **domínios** (pastas) e **stacks** (ecossistemas de tecnologia):

### Conhecimento agnóstico (independe de stack)

- **Fundamentos/** — Algoritmos, Estruturas de Dados, OOP, Banco de dados, Testes, Redes
- **Arquitetura/** — System Design, Design Patterns, API Design, Arquitetura de Software
...
- **Aprendizado/** — Trilhas de estudo, incluindo a [[Trilha Entrevistas]]
...
A [[Trilha Entrevistas]] é um roteiro sequencial com checkboxes. Siga as fases na ordem:
